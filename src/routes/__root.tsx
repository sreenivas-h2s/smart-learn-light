  ...
  head: () => ({
    meta: [
      ...
      { title: "Lumen — Adaptive Learning Intelligence" },
      {
        name: "description",
        content:
          "An AI tutor that tracks your knowledge state and adapts every lesson, question and hint to you.",
      },
      { property: "og:title", content: "Lumen — Adaptive Learning Intelligence" },
      {
        property: "og:description",
        content: "Personalized, adaptive learning with voice and camera.",
      },
